...
<h2>
    <a class="text-white fill-white hover:fill-gray-200 text-xl absolute left-5 top-5" href="{{ route('home') }}">
...
<h1 class="mb-1 text-4xl sm:text-5xl font-titulos">{{ $title ?? "" }}</h1>
