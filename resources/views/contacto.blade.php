...
<body class="font-principal">
    ...
    <div class="sm:flex justify-center m-5 sm:m-10">

        <div class="mx-5 mt-auto sm:mb-auto sm:mx-auto sm:text-[1.7vw]" >
            <p>Responsable:</p>
        ...
        <iframe class="border-4 h-[40vh] w-[80vw] mt-5 mx-auto sm:w-[50vw] sm:h-[70vh] border-cafe-sarabia rounded-3xl"
